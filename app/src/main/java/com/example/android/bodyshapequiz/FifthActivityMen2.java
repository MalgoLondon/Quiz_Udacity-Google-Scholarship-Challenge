...
public class FifthActivityMen2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nameUser.setText("Hi " + nameValue + "!" + " We need to ask you some more questions.");
        ...
        yesButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intentFirstYes = new Intent(FifthActivityMen2.this, SixthActivityMen.class);
        ...
        noButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intentFirstNo = new Intent(FifthActivityMen2.this, SixthActivityMen.class);
