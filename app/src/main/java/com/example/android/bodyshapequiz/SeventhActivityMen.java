...
public class SeventhActivityMen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seventh_men);
        ...
        yesButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intentFirstYes = new Intent(SeventhActivityMen.this, EightActivityMen.class);
        ...
        noButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intentFirstNo = new Intent(SeventhActivityMen.this, NinthActivityMen.class);
