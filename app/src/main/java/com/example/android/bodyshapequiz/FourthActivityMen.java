...
public class FourthActivityMen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fourth_men);
        ...
        yesButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intentFirstYes = new Intent(FourthActivityMen.this, SecondActivityMen.class);
        ...
        noButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intentFirstNo = new Intent(FourthActivityMen.this, ThirdActivityMen.class);
