...
public class FirstActivityMen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_first_men);
        ...
        nameUser.setText( getString(R.string.comment_first_activity_welcome) + nameValue + "!" + getString(R.string.comment_first_activity_men));
        ...
        yesButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intentFirstYes = new Intent(FirstActivityMen.this, SecondActivity.class);
        ...
        noButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intentFirstNo = new Intent(FirstActivityMen.this, ThirdActivity.class);
        ...
        equalButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //Open next Activity and pass on the name and the body type indicator score.
                Intent intentFirstEqual = new Intent(FirstActivityMen.this, FourthActivity.class);
